...
export class InmuebleSolicitudController {
  ...
  async find(
    ...
    return this.inmuebleRepository.solucitudes(id).find(filter);
  }
  ...
  async create(
    ...
    return this.inmuebleRepository.solucitudes(id).create(solicitud);
  }
  ...
  async patch(
    ...
    return this.inmuebleRepository.solucitudes(id).patch(solicitud, where);
  }
  ...
  async delete(
    ...
    return this.inmuebleRepository.solucitudes(id).delete(where);
  }
}
